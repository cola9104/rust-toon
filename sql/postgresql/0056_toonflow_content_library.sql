...
INSERT INTO toonflow.art_styles(id,name,file_url,label,prompt,create_time) VALUES (560100,'90年代日式动画','/toonflow-resources/art_skills/2D_90s_japanese_anime/1.png','2D_90s_japanese_anime','# 全局美学基础 · 90年代日式动画
...
```
','适用于 Seedance 2.0 多参数视频生成','seedance_2_multi_parameter') ON CONFLICT(id) DO UPDATE SET name=excluded.name,type=excluded.type,data=excluded.data,use_data=excluded.use_data,source_key=excluded.source_key;

INSERT INTO toonflow.prompts(id,name,type,data,use_data,source_key) VALUES (560301,'通用首尾帧视频提示词','视频生成','# 视频提示词生成 （通用首尾帧模式）
...
```','适用于需要首帧、尾帧或首尾帧控制的视频生成','universal_first_last_frame') ON CONFLICT(id) DO UPDATE SET name=excluded.name,type=excluded.type,data=excluded.data,use_data=excluded.use_data,source_key=excluded.source_key;

INSERT INTO toonflow.prompts(id,name,type,data,use_data,source_key) VALUES (560302,'通用多参数视频提示词','视频生成','# 视频提示词生成
...
```','适用于通用多参数视频生成','universal_multi_parameter') ON CONFLICT(id) DO UPDATE SET name=excluded.name,type=excluded.type,data=excluded.data,use_data=excluded.use_data,source_key=excluded.source_key;

INSERT INTO toonflow.prompts(id,name,type,data,use_data,source_key) VALUES (560303,'Wan 2.6 单图首帧视频提示词','视频生成','# 视频提示词生成
...
```','适用于 Wan 2.6 单图首帧视频生成','wan_2_6_single_image_first_frame') ON CONFLICT(id) DO UPDATE SET name=excluded.name,type=excluded.type,data=excluded.data,use_data=excluded.use_data,source_key=excluded.source_key;

SELECT setval('toonflow.prompts_id_seq', greatest((SELECT coalesce(max(id),1) FROM toonflow.prompts),1), true);

INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('8b1ba025b2370abb6619d9ed','f440bbe475f91aa320a7da15866c1a66','production_agent_decision.md','生产 Agent · 决策调度','Toonflow-app production_agent_decision.md',NULL,'production',1784260000000,1784260000000,1,'# 决策层 Agent 技能指令
...
| 记忆检索无结果 | 请求用户提供必要上下文 |
') ON CONFLICT(id) DO UPDATE SET md5=excluded.md5,path=excluded.path,name=excluded.name,description=excluded.description,type=excluded.type,update_time=excluded.update_time,state=excluded.state,content=excluded.content;

INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('a9c00d7aed6ae24643247731','411842a0e300392cc88ec5a3c6ec7121','production_agent_supervision.md','生产 Agent · 质量监督','Toonflow-app production_agent_supervision.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('e23a3bdbb96a9af75ba5cd58','a13bfb4990e38833320bec52bee5207a','production_execution_derive_assets.md','衍生资产生成','Toonflow-app production_execution_derive_assets.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('99c207db6876a6c312f2a776','00c0eb3ae9d978358dcb2094fb014cb4','production_execution_director_plan.md','导演计划执行','Toonflow-app production_execution_director_plan.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('e23f717fa2c4e64264862da5','5b3aeeafe3dbcd0c29478ea5291484da','production_execution_generate_assets.md','资产生成','Toonflow-app production_execution_generate_assets.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('9bd3d0584afaa50cebf8b96f','678cddd7572674d4efa146dcaa9bbc2f','production_execution_storyboard_gen.md','分镜生成','Toonflow-app production_execution_storyboard_gen.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('7d3ebabb3a0e0de6e04036f2','b4032a43b9fa6ff431f8849e78e2c07a','production_execution_storyboard_panel.md','分镜面板执行','Toonflow-app production_execution_storyboard_panel.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('3df2dbd55273aa8c22b36b95','73be1233b24dbce6f55e64efa3e59250','production_execution_storyboard_table.md','分镜表执行','Toonflow-app production_execution_storyboard_table.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('e2de33390fcd856d5763d44d','13fba2f21a1e94f20e2129944ccf9b48','production_skills/storyboard_prompt_techniques.md','分镜提示词技法','Toonflow-app production_skills/storyboard_prompt_techniques.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('97be954f22056a151ab0b0cf','22f62bce0c4ccb89434a30c44e0171c1','production_skills/storyboard_table_techniques.md','分镜表设计技法','Toonflow-app production_skills/storyboard_table_techniques.md',NULL,'production',1784260000000,1784260000000,1,'---
...
INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('10563f3621518cd2032038ec','156b2838e6b11ff02fb8fd6ceaf4a0f6','script_agent_decision.md','剧本 Agent · 决策调度','Toonflow-app script_agent_decision.md',NULL,'script',1784260000000,1784260000000,1,'# 决策层 Agent 技能指令
...
- 记忆检索无结果 → 请求用户提供必要上下文') ON CONFLICT(id) DO UPDATE SET md5=excluded.md5,path=excluded.path,name=excluded.name,description=excluded.description,type=excluded.type,update_time=excluded.update_time,state=excluded.state,content=excluded.content;

INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('deb2aaddc47e5846c9abae91','cf92c93f5f900eecb8544b9c9b7fcec8','script_agent_supervision.md','剧本 Agent · 质量监督','Toonflow-app script_agent_supervision.md',NULL,'script',1784260000000,1784260000000,1,'# 监督层 Agent 技能指令
...
- 是否明确了世界观锚点角色和观众视角对齐对象') ON CONFLICT(id) DO UPDATE SET md5=excluded.md5,path=excluded.path,name=excluded.name,description=excluded.description,type=excluded.type,update_time=excluded.update_time,state=excluded.state,content=excluded.content;

INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('5f8e37abb4d38eff814789bc','ea358df4b3bcae023859590a1e8f5273','script_execution_adaptation.md','改编策略制定','Toonflow-app script_execution_adaptation.md',NULL,'script',1784260000000,1784260000000,1,'# 改编策略制定 Agent
...
4. 观众视角对齐谁？（和主角一起发现 / 上帝视角）') ON CONFLICT(id) DO UPDATE SET md5=excluded.md5,path=excluded.path,name=excluded.name,description=excluded.description,type=excluded.type,update_time=excluded.update_time,state=excluded.state,content=excluded.content;

INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('6f97cdb809037376ffba465a','ad89605a059f865555f0663d01ab4131','script_execution_script.md','剧本编写','Toonflow-app script_execution_script.md',NULL,'script',1784260000000,1784260000000,1,'# 剧本编写 Agent
...
剧本输出的完整结构为：`<scriptItem name="...">` → 文件头 → 剧情梗概 → 剧本正文（△描述 + 台词 + OS/V.S.） → `</scriptItem>`') ON CONFLICT(id) DO UPDATE SET md5=excluded.md5,path=excluded.path,name=excluded.name,description=excluded.description,type=excluded.type,update_time=excluded.update_time,state=excluded.state,content=excluded.content;

INSERT INTO toonflow.skill_list(id,md5,path,name,description,embedding,type,create_time,update_time,state,content) VALUES ('f8887fd98fd9e79ea4f096c8','4290b4d6a87103a82e2bea050cf0cae9','script_execution_skeleton.md','故事骨架搭建','Toonflow-app script_execution_skeleton.md',NULL,'script',1784260000000,1784260000000,1,'# 故事骨架搭建 Agent
...
- [ ] 人物小传仅大三角核心角色（≤4人）；主角五要素+代入感五项+反差+金手指边界齐全且与故事核一致；反派有合理动机（非工具人）') ON CONFLICT(id) DO UPDATE SET md5=excluded.md5,path=excluded.path,name=excluded.name,description=excluded.description,type=excluded.type,update_time=excluded.update_time,state=excluded.state,content=excluded.content;
