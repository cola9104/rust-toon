...
import { Button, Card, Form, Image, Input, Modal, Popconfirm, Space, Table, Tag, message } from 'ant-design-vue';
import { deleteArtStyle, getArtStyles, saveArtStyle } from '#/api/toonflow';
const loading=ref(false), open=ref(false), styles=ref<ToonflowApi.ArtStyle[]>([]);
